exp.crit <- function(d,B)
{
  ...
  for (j in 1:B)
  {
    Y <- Res_Clcpp(xdata=X_data,distM=distM,para=theta_int[j,],Z1=t(Z_res[1:nrow(X_data),1]),Z2=t(Z_res[1:nrow(X_data),2]),Z3=c(Z_res[1:nrow(X_data),3]),v2=Unif_set[1:nrow(X_data)],r01=r01,r02=r02)
